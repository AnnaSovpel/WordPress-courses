...
<div id="comments" class="comments my-4">
	...
	if ( have_comments() ) :
		...
		<ol class="comment-list p-0">
			...
			wp_list_comments(
				array(
                    'walker'            => new Bootstrap_Walker_Comment, // какой шаблон испозовать для комментов
                    'max_depth'         => '2',  // максимальная вложенность 
                    'style'             => 'ol',
                    'type'              => 'all',
                    'reply_text'        => __('Ответить <i class="fa fa-reply"></i>'),
                    'per_page'          => '10', // сколько комментов на странице
                    'avatar_size'       => 80,
	...
	$defaults = [
        ...
        'comment_notes_before' => '<p class="comment-notes">
            <span id="email-notes">' . __( 'Ваш E-mail защищён от спама.' ) . '</span>
        </p>',
        'comment_notes_after'  => '',
        'id_form'              => 'commentform',
        'id_submit'            => 'submit',
        ...
        'class_submit'         => 'submit',
        'name_submit'          => 'btn btn-hero btn-circled',
        ...
        'submit_button'        => '<button name="%1$s" type="submit" id="%2$s" class="%3$s btn btn-hero btn-circled"/>%4$s</button>',
