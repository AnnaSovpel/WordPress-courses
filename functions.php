...
if(! function_exists('shaman_media_setup')) {
	function shaman_media_setup(){
		...
		// add_filter( 'pre_get_document_title', 'shaman_media_name_titel' );
		// 	function shaman_media_name_titel( $title ){
		// 		$title = 'Promodise - О нас';
		// 		return $title;
		// 	}
	}
...
// 	add_filter( 'nav_menu_css_class', 'cuastom_nav_menu_css_class', 10, 1 );//10 -приоритет выполнения, 1 - количество аргументов
// 	// получаем список всех классов пунктов меню
// 	function cuastom_nav_menu_css_class($classes){
