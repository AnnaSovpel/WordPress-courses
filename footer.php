    ...
    <div class="container">
      ...
      ?>
        ...
        <div class="col-lg-3 col-sm-6 col-md-6">
            <?php if ( ! dynamic_sidebar('sidebar-footer-contacts') ) : dynamic_sidebar('sidebar-footer-text'); endif; ?>
          </div>
       
      </div>
      <div class="row">
        <div class="col-lg-12 text-center">
          <div class="footer-copy">© <?php echo date('Y '); echo get_bloginfo('name');?> Promodise inc. Все права защищены.</div>
        </div>
      </div>
    </div>
  </section>
